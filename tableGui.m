...
% chstimuli(index).beforeBgColor = chstimuli(index).bgColor;
% chstimuli(index).bgColor = chstimuli(index).targetBgColor;
...
initBgColorEditBox(handles.editBgColor);
...
index    = navData.activeStim;
% chstimuli(index).beforeBgColor = chstimuli(index).bgColor;
chstimuli(index).targetBgColor = tbgc;
setappdata(0, 'chstimuli', chstimuli);
...
function initBgColorEditBox(hObject)
    navData    = getappdata(0, 'navData');
    chstimuli  = getappdata(0, 'chstimuli');
    index    = navData.activeStim;
    if ~isfield(chstimuli(index), 'targetBgColor')
        chstimuli(index).targetBgColor = 255;
        setappdata(0, 'chstimuli', chstimuli);
    end
    set(hObject, 'String', num2str(chstimuli(index).targetBgColor));
...
Screen('FillRect', screenData.wPtr,  chstimuli(index).targetBgColor);
